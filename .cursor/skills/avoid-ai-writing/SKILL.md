...
- **Excessive joined independent clauses with colons** Convert two clauses joined by a colon into a proper single-sentence without colon and/or two separate sentences. If we convert this into a single sentence, you may use "that" or ", which" or "where" or any words that connect the two; just not colons!
-- **Super short paragraphs** Convert two-sentence or three-sentence or few-sentence paragraphs into more developed paragraphs or merge them into previous paragraphs or the ones after them. 
-- **em dashes** Eliminate em dashes as much as you can. Consider also replace them with i.e. or e.g., which a re useful if the original writing inside the em dash is for saying in other words or examples, respectively. 
