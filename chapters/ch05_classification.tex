...
scale of the entire PDB~\cite{sword2022nar}.\sidenote{Domain boundaries predicted by automated methods
...
Integration is useful for more than convenience. Different member databases use
